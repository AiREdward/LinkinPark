    ...
    <div id="ticketContainer" style="max-width: 40rem; margin: 2rem auto;">
        ...
        <div class="event-details">
            ...
            <div class="event-header">
                <!-- Event Banner -->
                <img src="https://content.rockaroma.id//storage/articles/slider-65c939d00d016d9bbed4f5ca01667ce2.jpg" alt="Rockaroma Festival Banner" style="border-radius: 0.375rem; max-width: 30%;">
                <!-- Event Information -->
                <div class="event-info">
                    <p style="display: flex; align-items: center; font-weight: bold;">🎟️ Biglietto</p>
                    <p style="display: flex; align-items: center;" id="date">📅 Data</p>
                    <p style="display: flex; align-items: center;" id="time">⏰ Ora</p>
                    <p style="display: flex; align-items: center;">📍 Gambir Expo - Arena PRJ Kemayoran</p>
                </div>
            </div>
            <!-- Logo -->
            <div style="position: absolute; top: 1rem; right: 1rem;">
                <img src="https://assets.loket.com/neo/production/images/organization/20241004103026_66ff615227b10.png" alt="Logo" style="width: 6rem; height: auto;">
            </div>
        </div>
        ...
        <!-- Footer Section -->
        <div class="footer">
            <button id="printButton" style="padding: 0.5rem 1rem; background-color: #4CAF50; color: white; border: none; border-radius: 0.25rem; cursor: pointer;">Scarica Biglietto</button>
        </div>
    </div>
